...
try {
    ...
    if (!empty($app['identity_proof_file'])) {
        ...
        $html .= '<div class="mb-2">
                    ...
                    <a href="' . base_url('admin/serve_document.php?file=' . urlencode($app['identity_proof_file'])) . '" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
    ...
    if (!empty($app['shops_labour_license'])) {
        ...
        $html .= '<div class="mb-2">
                    ...
                    <a href="' . base_url('admin/serve_document.php?file=' . urlencode($app['shops_labour_license'])) . '" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
                        <i class="fas fa-download"></i> View/Download
                    </a>
                  </div>';
    }
    ...
    if (!empty($app['municipality_license'])) {
        ...
        $html .= '<div class="mb-2">
                    ...
                    <a href="' . base_url('admin/serve_document.php?file=' . urlencode($app['municipality_license'])) . '" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
                        <i class="fas fa-download"></i> View/Download
                    </a>
                  </div>';
    }
    ...
    if (!empty($app['msme_license'])) {
        ...
        $html .= '<div class="mb-2">
                    ...
                    <a href="' . base_url('admin/serve_document.php?file=' . urlencode($app['msme_license'])) . '" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
                        <i class="fas fa-download"></i> View/Download
                    </a>
                  </div>';
    }
    ...
    if (!empty($app['gst_license'])) {
        ...
        $html .= '<div class="mb-2">
                    ...
                    <a href="' . base_url('admin/serve_document.php?file=' . urlencode($app['gst_license'])) . '" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
                        <i class="fas fa-download"></i> View/Download
                    </a>
                  </div>';
    }
