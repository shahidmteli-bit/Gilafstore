...
function approveApplication(id) {
    ...
    if (confirm("Are you sure you want to APPROVE this application?")) {
        ...
        // Redirect
        window.location.href = "<?= base_url('admin/process_application.php'); ?>?id=" + id + "&action=approve";
    }
}
...
function rejectApplication(id) {
    ...
    if (reason !== null) {
        ...
        // Redirect
        window.location.href = "<?= base_url('admin/process_application.php'); ?>?id=" + id + "&action=reject&reason=" + encodeURIComponent(reason);
    }
}
...
function deleteApplication(id) {
    ...
    if (confirm("Are you sure you want to PERMANENTLY DELETE this distributor/application?\n\nThis action cannot be undone!")) {
        if (confirm("Final confirmation: Delete this distributor permanently?")) {
            ...
            // Redirect
            window.location.href = "<?= base_url('admin/delete_application.php'); ?>?id=" + id;
        }
    }
}
</script>
