...
<head>
    ...
    <link rel="stylesheet" href="<?= asset_url('css/layout-fixes.css'); ?>?v=<?= time(); ?>">

    <!-- Tablet Layout Fixes - Dedicated tablet optimization (768px-1024px only) -->
    <link rel="stylesheet" href="<?= asset_url('css/tablet-layout-fixes.css'); ?>?v=<?= time(); ?>?v=<?= time(); ?> ?>?v=<?= time(); ?>">

    <!-- Mobile Responsive - Universal mobile layout for all phone sizes -->
    <link rel="stylesheet" href="<?= asset_url('css/mobile-responsive.css'); ?>?v=<?= time(); ?>">

    <!-- Mobile Section Titles - Fluid typography for section headings -->
    <link rel="stylesheet" href="<?= asset_url('css/mobile-section-titles.css'); ?>?v=<?= time(); ?>">

    <!-- Mobile Tagline Fix - Force single line on mobile -->
    <link rel="stylesheet" href="<?= asset_url('css/mobile-tagline-fix.css'); ?>?v=<?= time(); ?>">

    <!-- Enhanced Product Layout - Reference Design Styling -->
    <link rel="stylesheet" href="<?= asset_url('css/product-layout-enhanced.css'); ?>?v=<?= time(); ?>">

    <!-- ADAPTIVE STRUCTURE - STRICT CATEGORY LOCKING (Must be last) -->
    <link rel="stylesheet" href="<?= asset_url('css/adaptive-structure.css'); ?>?v=<?= time(); ?>">
        ...
        <div class="container nav-container">
            ...
            <div class="user-actions">
                ...
                <a href="<?= base_url('cart.php'); ?>"
                    ...
                    <?php if ($cartCount > 0): ?>
                        <span
                            style="position: absolute; top: -5px; right: -8px; background: var(--color-gold); color: white; font-size: 10px; padding: 2px 5px; border-radius: 50%; pointer-events: none;"><?= $cartCount; ?></span>
                    <?php endif; ?>
                </a>
            </div>
        </div>
