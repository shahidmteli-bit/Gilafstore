...
<style>
  ...
  /* FORCE 2-COLUMN MOBILE PRODUCT GRID - DISABLED FOR STRICT ADAPTIVE STRUCTURE
@media (max-width: 768px) {
    .products-grid {
    ...
    <div class="shop-page">
      ...
      <aside class="shop-filters" id="shopFilters">
        <div class="shop-filters-header">
          ...
          <button class="shop-filters-clear" onclick="window.location.href='<?= base_url('shop.php'); ?>'">Clear
            All</button>
        </div>
        ...
        <div class="filter-section">
          ...
          <div class="filter-section-content">
            <label class="filter-option">
              <input type="checkbox" class="filter-checkbox" <?= !$categoryId ? 'checked' : ''; ?>
                onchange="window.location.href='<?= base_url('shop.php'); ?>'">
              <span class="filter-label">All Products</span>
              <span class="filter-count"><?= count($products); ?></span>
            </label>
            <?php foreach ($categories as $category): ?>
              <label class="filter-option">
                <input type="checkbox" class="filter-checkbox" <?= $categoryId === (int) $category['id'] ? 'checked' : ''; ?>
                  onchange="window.location.href='<?= base_url('shop.php?category=' . (int) $category['id']); ?>'">
            ...
            <div class="trust-highlights-container" style="position: relative; height: 68px; margin-bottom: 0;">
              <div class="trust-highlights-track">
                ...
                <div class="trust-highlight-card active">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 252, 248, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(201, 169, 97, 0.18); border: 1.5px solid rgba(201, 169, 97, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #C9A961, #D4B76A); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(201, 169, 97, 0.4);">
                      🚀</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Fast Delivery</div>
                      <div
                        style="font-size: 0.68rem; color: #3a4a45; line-height: 1.2; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Quick shipping</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(252, 250, 255, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(102, 126, 234, 0.18); border: 1.5px solid rgba(102, 126, 234, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">
                      ↩️</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 255, 255, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(48, 207, 208, 0.18); border: 1.5px solid rgba(48, 207, 208, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #30cfd0, #330867); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(48, 207, 208, 0.4);">
                      🔒</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 250, 250, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(255, 107, 107, 0.18); border: 1.5px solid rgba(255, 107, 107, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #FF6B6B, #FF8E53); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(255, 107, 107, 0.4);">
                      🔬</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 255, 253, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(168, 237, 234, 0.18); border: 1.5px solid rgba(168, 237, 234, 0.35);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #a8edea, #fed6e3); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(168, 237, 234, 0.4);">
                      📍</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Traceable Source</div>
                      <div
                        style="font-size: 0.68rem; color: #3a4a45; line-height: 1.2; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Know origin</div>
                    </div>
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 250, 255, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(240, 147, 251, 0.18); border: 1.5px solid rgba(240, 147, 251, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #f093fb, #f5576c); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(240, 147, 251, 0.4);">
                      ✓</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Certified Quality</div>
                      <div
                        style="font-size: 0.68rem; color: #3a4a45; line-height: 1.2; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        Premium grade</div>
                    </div>
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 253, 248, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(250, 112, 154, 0.18); border: 1.5px solid rgba(250, 112, 154, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #fa709a, #fee140); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(250, 112, 154, 0.4);">
                      ⭐</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                ...
                <div class="trust-highlight-card">
                  <div
                    style="display: flex; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 252, 248, 0.98) 100%); backdrop-filter: blur(10px); padding: 10px; border-radius: 8px; box-shadow: 0 3px 15px rgba(201, 169, 97, 0.18); border: 1.5px solid rgba(201, 169, 97, 0.3);">
                    <div
                      style="flex-shrink: 0; width: 36px; height: 36px; background: linear-gradient(135deg, #C9A961, #1A3C34); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 12px rgba(201, 169, 97, 0.4);">
                      📦</div>
                    <div style="flex: 1; min-width: 0;">
                      <div
                        style="font-size: 0.8rem; font-weight: 700; color: #0d1f1a; margin-bottom: 2px; font-family: 'Poppins', sans-serif; letter-spacing: 0.05px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
      ...
      <div class="shop-products">
        ...
        <div class="products-grid">
          <?php foreach ($products as $product): ?>
            <article class="product-card animate-fadeIn"
              data-product-url="<?= base_url('product.php?id=' . (int) $product['id']); ?>"
              data-product-id="<?= (int) $product['id']; ?>" tabindex="0" role="link"
              aria-label="View details for <?= htmlspecialchars($product['name']); ?>" style="cursor: pointer;">
              <div class="product-image-wrapper"
                onclick="event.stopPropagation(); window.location.href='<?= base_url('product.php?id=' . $product['id']); ?>'"
                ...
                <div class="price-row">
                  ...
                  <?php } else {
                    ...
                    <?php if (isset($product['original_price']) && $product['original_price'] > $product['price']): ?>
                      <span
                        class="product-price-original"><?= display_price($product['original_price'], $currentCurrency, $currentCurrencySymbol); ?></span>
                    <?php endif; ?>
...
<button class="shop-filters-mobile-toggle" style="left: 24px !important; right: auto !important;"
  onclick="document.getElementById('shopFilters').classList.toggle('open'); document.getElementById('filterOverlay').classList.toggle('open');">
  <i class="fas fa-filter"></i> Filters
</button>
<div class="shop-filters-overlay" id="filterOverlay"
  onclick="document.getElementById('shopFilters').classList.remove('open'); this.classList.remove('open');"></div>
